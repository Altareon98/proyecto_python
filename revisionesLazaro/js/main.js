$(document).ready(function () {
    ...
    $("#btnCrearAlumno").click(function () {
        ...
        $.ajax({
            method: "POST",
            url: "http://localhost/proyecto_python/webService/alumno.py",
    ...
    $('#btnCargar').click(function(){
        $.ajax({
            method: "GET",
            async: false,
            url: "http://localhost/proyecto_python/webService/cargarArchivo.py",
    ...
    $('#btnDescargar').click(function(){
        $.ajax({
            method: "GET",
            url: "http://localhost/proyecto_python/webService/generarArchivo.py",
            success:function(msg){
                let nombre = 'lista_alumnos_2020.json';
                let archivo = new Blob([msg], {type: 'text/plain'});
            ...
            $("#tablaAlumnos tbody tr td").find('.editar').click(function () {
                ...
                $.ajax({
                    ...
                    success:function(msg){
                        msg = msg.replaceAll("'", "\"")
                        let json = JSON.parse(msg)
                        //console.log(json.Fecha_Nacimiento);
